...
if (lovesCode == false){
    console.log("coding has its callenges");
}
...
/*
  ...
  If it is 80 degrees or above, and raining, one should wear a t-shirt and take an umbrella. If it is between 60 and 80 degrees, and raining, one should wear a rain-jacket. If it is 60 degrees or below, one should wear a jacket and carry an umbrella.
...
if (temperature <= 60 && rain == true){
    console.log("you should wear a jacket and carry and umbrella");
}
if (temperature >= 80 && rain == false){
    console.log("you should wear a cool t-shirt");
}
if (temperature >= 60 && temperature <= 80 && rain == false){
    console.log("you should wear a long sleeve tee");
}
